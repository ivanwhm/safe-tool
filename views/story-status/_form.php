...
$nameHelp = Icons::getIcon(Icons::FORM_HELP) . Yii::t('story-status', 'Input the name of the story status.');
$readyHelp = Icons::getIcon(Icons::FORM_HELP) . Yii::t('story-status', 'Please tell if the ready property is yes or no.');
$activeHelp = Icons::getIcon(Icons::FORM_HELP) . Yii::t('story-status', 'Please tell if the story status is active or inactive.');
